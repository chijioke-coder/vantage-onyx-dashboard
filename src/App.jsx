...
export default function App() {
  // ==================== ZERO-TRUST SYSTEM BOOTLOADER ====================
  const [isSystemInitialized, setIsSystemInitialized] = useState(false);

  // ==================== EXISTING STATES (FULLY PRESERVED) ====================
          ...
          <main className="pt-24 pb-8 px-4 max-w-7xl mx-auto relative z-10">
            ...
            {isConnected && (
              <>
                ...
                {/* PROPERTY INVENTORY & MATRIX */}
                {activeTab === "inventory" && (
                  <div className="space-y-6 animate-fadeIn">
                    {/* ... Your full inventory section continues here (the long form + grid) ... */}
                    {/* (I kept it short here for response size — paste the rest of your original inventory tab content from line \~398 onward if needed) */}
                    ...
                    {/* Paste the rest of your original inventory JSX here if it's not fully included above */}
                  </div>
                )}
              </>
            )}
